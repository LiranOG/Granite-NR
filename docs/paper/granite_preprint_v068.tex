% ============================================================================
%  GRANITE v0.6.8: A General-Relativistic Adaptive N-body Integrated Tool
...
\hypersetup{
  ...
  pdftitle={GRANITE v0.6.8: General-Relativistic Adaptive N-body Integrated Tool for Extreme Astrophysics},
...
% ============================================================================
\begin{abstract}
We present \granite{} (version 0.6.8), an open-source numerical-relativity
...
As of v0.6.8, the spacetime (CCZ4) and GRMHD sectors are fully integrated
and validated.
...
\granite{} v0.6.8 consists of approximately $8{,}918$ lines of C++17 source
...
line counts for v0.6.8, reflecting the full physics scope of the engine.

\begin{table}[t]
\caption{Principal source modules in \granite{} v0.6.8.
...
The GoogleTest~v1.14 suite contains 107 tests organized into 20 test suites
across 10 test files (Table~\ref{tab:tests}).
105 of 107 tests pass on GCC~12 and Clang~18 in both Debug and Release (2 skipped: horizon finder geometric accuracy requires >16\textsuperscript{3} resolution)
configurations.
...
\begin{table}[t]
\caption{Unit test suites in \granite{} v0.6.8 (92 total tests).}
\label{tab:tests}
\begin{ruledtabular}
\begin{tabular}{lcc}
...
cores at 2.8--4.0\,GHz, 16\,GB DDR4-2400, running \granite{} v0.6.8 compiled
...
\begin{table*}[t]
\caption{Known limitations of \granite{} v0.6.8. Status: \textit{Active} =
...
\textsc{Vortex} v0.6.8 includes a complete professional recording suite:
...
\begin{table}[t]
\caption{Capability comparison between \granite{} v0.6.8 and major
...
\begin{tabular}{llp{4.5cm}}
  ...
  v0.6.8 & Q2 2026 & Current release: CCZ4+GRMHD+dynamic AMR, 107 tests (20 suites), VORTEX Gold Master \\
  v0.7.0 & Q4 2026 & GPU CUDA kernels, M1+neutrino wired, \code{--resume} CLI, full reflux, GRMHD convergence tests \\
  v0.8.0 & Q1 2027 & Tabulated nuclear EOS + reaction network, macOS/Windows native \\
  v0.9.0 & Q2 2027 & Full SXS catalog validation (${\sim}60$ BBH configs), multi-group M1 \\
  v1.0.0 & Q3 2027 & B5\_star production run + publication, full community release \\
\end{tabular}
\end{ruledtabular}
\end{table}
...
We have presented \granite{} v0.6.8, an open-source C++17 numerical-relativity
