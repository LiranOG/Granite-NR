...
### Fixed
- **Stale Links Sanity Pass:** Globally replaced stale repository URLs (missing the -NR suffix) with `github.com/LiranOG/Granite-NR` across 15+ documentation files, `CMakeLists.txt`, `CITATION.cff`, and `pyproject.toml`.
